...
-- vim.o.colorcolumn = '120'- [[ Basic Keymaps ]]
...
require('lazy').setup({
  ...
  -- upstream switched to guess-indent in mayish 2025, hopefully it works better
  -- changed 2025-09-12 holden
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      -- format on save is the most fucking annoying bullshit stupid option to have as a default. why the fuck is this even a thing? fucking annoying
